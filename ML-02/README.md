...
3. **Feature Engineering**: ทำการแปลงข้อมูลประเภทข้อความ (Categorical Data) ให้อยู่ในรูปตัวเลขด้วยวิธี Label Encoding และ One-Hot Encoding เพื่อเตรียมพร้อมสำหรับนำไปเทรนโมเดล AI
